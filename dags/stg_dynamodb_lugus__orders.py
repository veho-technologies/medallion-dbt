...
with DAG('dbt.stg_dynamodb_lugus__orders', description='DBT Task running - stg_dynamodb_lugus__orders Model',
    ...
    dbt_ecs_operator = EcsOperator(
        task_id="ecs_run_stg_dynamodb_lugus__orders",
            ...
            "containerOverrides": [
                {
                    "name": "dbt",
                    "command": [
                        "--select", "stg_dynamodb_lugus__orders"
                    ],
                },
            ],
        },
