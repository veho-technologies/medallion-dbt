...
with DAG('dbt.stg_dynamodb_lugus__order_sensitive_data', description='DBT Task running - stg_dynamodb_lugus__order_sensitive_data Model',
    ...
    dbt_ecs_operator = EcsOperator(
        task_id="ecs_run_stg_dynamodb_lugus__order_sensitive_data",
            ...
            "containerOverrides": [
                {
                    "name": "dbt",
                    "command": [
                        "--select", "stg_dynamodb_lugus__order_sensitive_data"
                    ],
                },
            ],
        },
