...
with DAG('dbt.stg_dynamodb_lugus__orderlog', description='DBT Task running - stg_dynamodb_lugus__orderlog Model',
    ...
    dbt_ecs_operator = EcsOperator(
        task_id="ecs_run_stg_dynamodb_lugus__orderlog",
            ...
            "containerOverrides": [
                {
                    "name": "dbt",
                    "command": [
                        "--select", "stg_dynamodb_lugus__orderlog"
                    ],
                },
            ],
        },
